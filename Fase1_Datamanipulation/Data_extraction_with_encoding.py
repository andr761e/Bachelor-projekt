...
# Find positionen af "HomeRedCards5" i DataFrame
insert_position = form_stats_df.columns.get_loc("HomeRedCards5") + 1

# Indsæt udeholdets encoding efter "HomeRedCards5"
form_stats_df = pd.concat([
