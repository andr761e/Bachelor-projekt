...
# 🔥 Hjemmesejr (H) med thresholds 0.05 og 0.07
monte_carlo_simulation2(df = LR, result_char = "H", 
                       pred_col = "YpredH", true_col = "YtrueH", 
                       diff_col = "DiffH", result_col = "FTR", 
                       lower_threshold = 0.05, upper_threshold = 0.07, 
                       bet_amount = 100, simulations = 10000)
...
# 🔥 Hjemmesejr (H) med thresholds 0.05 og 0.07
monte_carlo_simulation2(df = TNN, result_char = "H", 
                       pred_col = "YpredH", true_col = "YtrueH", 
                       diff_col = "DiffH", result_col = "FTR", 
                       lower_threshold = 0.05, upper_threshold = 0.07, 
                       bet_amount = 100, simulations = 10000)
...
# 🔥 Hjemmesejr (H) med thresholds 0.05 og 0.07
monte_carlo_simulation2(df = TLR, result_char = "H", 
                       pred_col = "YpredH", true_col = "YtrueH", 
                       diff_col = "DiffH", result_col = "FTR", 
                       lower_threshold = 0.05, upper_threshold = 0.07, 
                       bet_amount = 100, simulations = 10000)
...
# 🔥 Hjemmesejr (H) med thresholds 0.05 og 0.07
monte_carlo_simulation2(df = TCB, result_char = "H", 
                       pred_col = "YpredH", true_col = "YtrueH", 
                       diff_col = "DiffH", result_col = "FTR", 
                       lower_threshold = 0.05, upper_threshold = 0.07, 
                       bet_amount = 100, simulations = 10000)
