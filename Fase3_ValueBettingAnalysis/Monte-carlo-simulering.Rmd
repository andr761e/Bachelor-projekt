...
monte_carlo_simulation2 <- function(df, result_char, pred_col, odds_col, diff_col, 
  ...
  for (i in 1:simulations) {
    ...
    for (j in 1:nrow(sampled_df)) {
      ...
      # Beregn indsats som andel af nuværende bankroll (eller max 10%)
  ...
  # Beregn ændring i profit (ift. startbankroll)
...
```{r}
monte_carlo_simulation2(df = NN, result_char = "A", 
                       pred_col = "YpredA", odds_col = "MaxAodds", 
                       diff_col = "DiffA", result_col = "FTR", 
                       threshold = 0.01, initial_bank = 60000, simulations = 10000)
```
